...
class Tools2 extends StatefulWidget {
  ...
  Tools2({this.clase, this.cofe, this.tea, this.titelBote,this.acceq});

  @override
  _Tools2State createState() => _Tools2State();
}

class _Tools2State extends State<Tools2> {
          ...
          Row(
            children: [
              Padding(
                ...
                child: InkWell(
                  onTap: () {
                    _fuvkshen.showBtom(context, vlue2, vlue);
                  },
                  child: Container(
                    height: sh*0.06,
                    width: sw*0.4,
